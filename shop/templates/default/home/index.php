...
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL;?>/layer/layer.js" charset="utf-8"></script>
<!--[if IE 6]>
...
<div class="home-focus-layout"> <?php echo $output['web_html']['index_pic'];?>
  <div class="right-sidebar">
    ...
    <div class="proclamation">
      ...
      <div class="tabs-panel tabs-hide"> <a href="<?php echo urlShop('show_joinin', 'index');?>" title="申请商家入驻；已提交申请，可查看当前审核状态。" class="store-join-btn" target="_blank">&nbsp;</a> <a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" class="store-join-help"><i class="icon-cog"></i>登录商家管理中心</a> </div>
...
<?php include template('home/home_ad');?>
