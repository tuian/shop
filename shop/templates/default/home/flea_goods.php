 ...
 <div class="share">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
    ...
    <div id="seller_info" class="flea_gray mb10">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="index.php?act=home&op=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/web_mail.gif"></a></p>
    </div>
    <div id="seller_info" class="flea_gray mb10">
