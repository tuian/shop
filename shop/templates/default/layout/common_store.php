...
<div style=" position:absolute; z-index:1; top:0; right:0; "><a style="CURSOR: hand" onClick="homeTopAd()"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/close.png" width="32" height="32" /></a></div>
</DIV>
      ...
      <div class="download-app">
       <div class="qrcode"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('mobile_app');?>" ></div>
        <div class="hint">
          ...
          下载手机客户端</div>
          <div class="addurl">
			<a href="http://www.phphos.com" target="_blank"><i class="icon-android"></i>Android</a>
			<a href="http://www.phphos.com" target="_blank"><i class="icon-apple"></i>iPhone</a>
		  </div>
