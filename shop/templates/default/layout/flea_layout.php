...
<div id="navBar" class="mb10">
  <ul>
    ...
    <li class="fn-left link" <?php echo $output['index_sign'] == 'flea' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=flea"><span>闲置市场</span><span class="line"></span></a></li>
    <?php }?>     
