...
<a href="javascript:void(0);" target="_blank"><img src="<?php echo $output["goods_image"]["0"]["1"] ?>" rel="<?php echo $output["goods_image"]["0"]["2"] ?>" class="jqzoom"></a>
</div>
