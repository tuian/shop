...
<ul class="add-goods-step">
  ...
  <li class="<?php $output['step']=="3" ? print "current" : print "";?>"><i class="icon icon-ok-circle"></i>
    <h6>STIP.3</h6>
    <h2><?php echo $lang['store_goods_import_step3'];?></h2>
  </li>
</ul>
<!--S 分类选择区域-->
<!--S 分类选择区域-->
...
<form method="post" action="index.php?act=taobao_import&op=index" enctype="multipart/form-data" id="goods_form">
  ...
  <div class="ncsc-form-goods" id="step2" <?php if($output['step'] != '2'){?> style="display:none"<?php }?>>
    </ul>
    <!--stpe2-->
    <dl>
  ...
  <div class="ncsc-form-goods"  id="step3"  style="display:none"> 
    ...
    <dl>
      <dt>&nbsp;</dt>
      <dd>
        <input name=""  class="submit" value="<?php echo $lang['store_goods_import_pack'];?>" onclick="window.location.href='index.php?act=taobao_import&op=date_pack&goods_id_str='+'<?php echo $output['goods_id_str'];?>';"/>
      </dd>
    </dl>
    </ul>
  </div>
