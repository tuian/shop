    ...
    <table class="ncm-search-table">
      ...
      <tr><td class="w600">&nbsp;</td>
        ...
        <td class="w100"><select name="is_get">
            ...
            <option value="1" <?php if ($output['is_get'] == '1'){echo 'selected=selected';}?>>已派奖</option>
            <option value="0" <?php if ($output['is_get'] == '0'){echo 'selected=selected';}?>>未派奖</option>
          </select>
        </td>
        <td class="tl">
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><?php echo $val['participant_time'];?></td>
        <td><?php
	              	switch ($val['is_get']){
	              		case '1':
	              			echo '已派奖';
	              ...
	              ?></td>
        <td class="tl"><?php echo  $val['get_time'];?></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
      <tr>
