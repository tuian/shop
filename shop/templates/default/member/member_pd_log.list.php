...
<div class="wrap">
  <div class="tabmenu">
    ...
    <!--<a class="ncm-btn ncm-btn-green" href="index.php?act=predeposit&op=jftb" style="right: 207px;"><i class="icon-money"></i>同步充值</a>--> <a class="ncm-btn ncm-btn-orange" title="在线充值" href="index.php?act=predeposit&op=recharge_add" style="right: 107px;"><i class="icon-shield"></i>在线充值</a> <a class="ncm-btn ncm-btn-blue" href="index.php?act=predeposit&op=rechargecard_add"><i class="icon-shield"></i>充值卡充值</a> </div>
