    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="40" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'demo';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div>
          ...
          <h4>演示数据，如果选择安装演示数据，请下载<a href="http://byu1659920001.my3w.com/downloads/b2b2c.php" target="_blank">图片文件压缩包</a></h4></div>
        <?php }?>
