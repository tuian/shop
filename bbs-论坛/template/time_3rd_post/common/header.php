...
<div class="topbar">
  <div class="topwrap">
    ...
    <div class="userbox"> 
      <!--{if $_G['uid']}-->
      <div style="float: right;"> <a href="home.php?mod=space&uid=$_G[uid]" title="{$_G[member][username]}" class="userinfo" id="m" onMouseOver="showMenu({'ctrlid':'m','pos':'34!','ctrlclass':'hover','duration':2});"> <span class="user_avt">{$_G[member][username]}</span><i class="arrow"></i></a> </div>
      <ul class="usernav">
      ...
      <ul class="usernav user_part">
        ...
        <li class="user_list"><a href="member.php?mod={$_G[setting][regname]}" class="user_link" style="padding: 0 5px 0 8px;">注册</a></li>
