...
0
|| checktplrefresh('./template/time_3rd_post/member/register.htm', './template/default/common/seccheck.htm', 1419659857, '2', './data/template/2_2_member_register.tpl.php', './template/time_3rd_post', 'member/register')
...
<div class="mn" style="margin-top: 20px; background: #F6F6F6;">

<div class="bm" id="main_message" style="background: #F6F6F6;">

<div class="bm_h" id="main_hnav" style="padding: 10px; border-bottom: 1px solid #EEEEEE;">
<span class="y">
...
<h3 id="layer_reginfo_t" style="font-size: 16px;">
<?php if($_GET['action'] != 'activation') { ?><?php echo $this->setting['reglinkname'];?><?php } else { ?>您的帐号需要激活<?php } ?><em style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; font-size: 12px; color: #999999; padding-left: 5px;">/register</em>
</h3>
</div>
