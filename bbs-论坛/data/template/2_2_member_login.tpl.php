...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1419409182, '2', './data/template/2_2_member_login.tpl.php', './template/time_3rd_post', 'member/login')
