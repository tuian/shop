<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><meta http-equiv="content-type" content="text/html; charset=utf-8" />
<script src="template/time_3rd_post/src/js/superslide.2.1.js" type="text/javascript"></script>
...
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost"><?php echo cutstr($forum['lastpost']['subject'], 30); ?></a> <?php if($forum['lastpost']['author']) { ?><p>by <?php echo $forum['lastpost']['author'];?><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?></p><?php } ?><cite><?php echo $forum['lastpost']['dateline'];?></cite>
<?php } else { ?>
从未
<?php } } ?>
</div>
...
<?php if(empty($forum['redirect'])) { ?><span class="f_threads"><?php echo dnumber($forum['threads']); ?></span><div class="line"> / </div><span class="f_posts"><?php echo dnumber($forum['posts']); ?></span><?php } ?></div>
</td>
</tr>
<tr class="fl_row">
...
<dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></dt>
                                    <dd><?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } ?></dd>
...
<td class="fl_i">
                            <div class="time_relative">
<?php if(empty($forum['redirect'])) { ?><span class="f_threads"><?php echo dnumber($forum['threads']); ?></span><span class="line"> / </span><span class="f_posts"><?php echo dnumber($forum['posts']); ?></span><?php } ?></div>
</td>
</tr>
<tr class="fl_row">
<?php } } ?>
...
<div class="bm lk">
            <div class="bm_h cl">
               <h2><a>友情链接<em style="color: #999999; font-size: 12px; padding-left: 5px;">- 申请本站友情链接交换必须满足PR值等于2或以上</em></a></h2>
               <span style="float: right; margin: 2px 0 0 0;"><a href="#" style="color: #777777;">申请+</a></span>
            </div>
